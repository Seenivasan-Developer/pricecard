   ...
   <div className="col-lg-4">
          <div className="card mb-5 mb-lg-0">
            <div className="card-body">
              ...
              <h6 className="card-price text-center">${details.price}/month</h6>
              <hr/>
              <ul className="fa-ul">
                <li className={details.isUser?"":"text-muted"}><span className="fa-li"><i className={details.isUser?"fas fa-check":"fas fa-times"}></i></span>{details.storage}</li>
                <li className={details.isStorage?"":"text-muted"}><span className="fa-li"><i className={details.isStorage?"fas fa-check":"fas fa-times"}></i></span>{details.user}</li>
                ...
                <li className={details.isCommunityAccess?"":"text-muted"}><span className="fa-li"><i className={details.isCommunityAccess?"fas fa-check":"fas fa-times"}></i></span>{details.access}</li>
